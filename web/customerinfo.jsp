<%-- 
    ...
    Created on : 23 Feb, 2018, 11:57:02 AM
    Author     : DINESH
--%>
...
#cus tr:nth-child(even){background-color: #ffcc00;}

#cus tr:hover {background-color: #ffff00;}
...
.submit {
    ...
    <body>
        <center><h1><b>VIEW CUSTOMER INFO SECTION</b></h1></center><br><br><br>
    <form action="check1.jsp" target="_parent">
        <center>
         <table border="2" id="cus">
            <tr>
                <th>CUSTOMER NAME</th>
