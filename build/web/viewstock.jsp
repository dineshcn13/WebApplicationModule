<%-- 
    Document   : viewstock
    Created on : 22 Feb, 2018, 9:51:17 PM
    Author     : DINESH
--%>
...
.submit {
    ...
    <body>
    <center><h1><b>VIEW CURRENT PRODUCT STOCK SECTION</b></h1></center><br><br><br>
    <form action="check1.jsp">
        ...
        <%
                ...
                <tr>
                    ...
                    <td><a href="deleteprod?id=<%=resultset.getInt(2)%>"><center><img src="del2.png" width="30" height="30"></center></a></td>
                </tr>
                <%
                    }
                    %>
